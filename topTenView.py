...
class TopTenView(Frame):
	def __init__(
		...
		#
		# # Η λίστα με τα στοιχεία των παικτών είναι στο playerList
		#
		# # Με χρήση label προβάλλουμε τα στοιχεία των παικτών
		# # ή εναλλακτικά μπορούμε να χρησιμοποιήσουμε TreeView
		#
	...
	def afterInit(self):
		self.backToMenu = Button(master=self, text='Back to menu', command=self.controller.mainMenuView)
		self.backToMenu.pack()
