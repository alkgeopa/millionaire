...
για να κερδίσει ένα εικονικό χρηματικό ποσό.
Η κάθε ερώτηση έχει 4 επιλογές ώς απαντήσεις με μία μόνο από αυτές σωστή.
Ο παίκτης μπορεί να κάνει μέχρι 2 λάθη, στο 3ο λάθος χάνει.
Κάθε λανθασμένη ερώτηση αντικαθίσταται από μια καινούρια.
